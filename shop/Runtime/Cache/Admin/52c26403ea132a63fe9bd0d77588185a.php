...
<head>
    ...
    <link href="/shop/Public/Css/User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <form action="#" method="post">
            <ul>
                    ...
                    <div class="user_main_box">
                        ...
                        <ul>
                            ...
                            <li class="user_main_input">
                                ...
                                <img src="/shop/index.php/Admin/Manager/verifyImg"  alt="" onclick="this.src='/shop/index.php/Admin/Manager/verifyImg/'+Math.random()" />
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="user_main_r">
                    ...
                    <input style="border: medium none; background: url('../../../Public/Img/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                </li>
            </ul>
        </form>
